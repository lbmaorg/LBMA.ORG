...
;(function($){
	...
	$.fn.scrollabletab = function(options){
		...
		return this.each(function(){
			...
			$('#event_header').prepend(
			  $nav = $('<div id="event_next_previous" />')
			  		.disableSelection()
					...
					.append(
						$('<span/>')
							...
							.css(arrowsCommonCss)
							.addClass('stPrev stNav')
							.css('right',34)
                                                        .css({'color':'#FFF','padding': '0.1em 0.6em 0.4em 0.6em','font-size': '16px'})
							.append($('<span/>').disableSelection().html('&#9668;').css('margin-top',arrowsTopMargin))
							.click(function(){
								//Check if disabled
						...
						$('<span/>')
							...
							.attr('title','Next tab')
							.css(arrowsCommonCss)
							.addClass('stNext stNav')
							.css({'right':3,'color':'#FFF','padding': '0.1em 0.6em 0.4em 0.6em','font-size': '16px'})
							.append($('<span/>').addClass('').html('&#9658;').css('margin-top',arrowsTopMargin))
							.click(function(){
								//Just select the previous tab and trigger scrollToTab event
